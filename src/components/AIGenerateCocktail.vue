        ...
        <div v-else class="space-y-6">
          ...
          <div class="grid grid-cols-2 gap-3">
            <button
              ...
              class="py-3 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-xl font-medium transition flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              class="py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-xl font-medium transition flex items-center justify-center gap-2"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            class="w-full py-3 bg-slate-700/50 hover:bg-slate-600/50 text-slate-300 rounded-xl transition flex items-center justify-center gap-2 mt-3"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
