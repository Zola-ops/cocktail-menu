...
export function useAICocktail() {
  ...
  const ingredients: Record<BaseSpirit, string[]> = {
    ...
    '清酒': ['纯米吟酿', '大吟酿', '本酿造', '生酒', '古酒', '清酒', '梅酒'],
    '梅酒': ['梅酒', '蜂蜜梅酒', '绿茶梅酒', '紫苏梅酒', '浊梅酒'],
    '雪利酒': ['菲诺雪利酒', '曼萨尼亚雪利酒', '奥洛罗索雪利酒', '佩德罗西梅内斯雪利酒', '奶油雪利酒'],
    '波特酒': ['红宝石波特酒', '白波特酒', '茶色波特酒', '年份波特酒', '白牌波特酒'],
    '开胃酒': ['金巴利', '阿佩罗', '杜本内', '西娜尔', '茴香酒', '茴香开胃酒'],
    '白酒': ['茅台', '五粮液', '泸州老窖', '汾酒', '古井贡酒', '洋河大曲', '郎酒', '水井坊']
  }
