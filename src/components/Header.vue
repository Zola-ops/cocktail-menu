        ...
        <div class="hidden sm:flex flex-1 justify-center mx-4">
          <div class="relative w-full max-w-md">
            <input
              ...
              type="text"
              placeholder="// 搜索调酒..."
              class="w-full px-4 py-2 pl-10 bg-[var(--cyber-dark-2)] border border-[var(--neon-cyan)]/30 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-[var(--neon-cyan)] focus:shadow-[var(--glow-cyan)] transition-all cursor-text"
            />
      ...
      <div class="sm:hidden mt-3">
        <div class="relative">
          <input
            ...
            type="text"
            placeholder="// 搜索调酒..."
            class="w-full px-5 py-3 pl-12 bg-[var(--cyber-dark-2)] border border-[var(--neon-cyan)]/30 rounded-lg text-base text-white placeholder-slate-500 focus:outline-none focus:border-[var(--neon-cyan)] focus:shadow-[var(--glow-cyan)] transition"
          />
          <svg class="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[var(--neon-cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
          </svg>
        </div>
      </div>
